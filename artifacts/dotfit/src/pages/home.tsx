      ...
      <section className="py-24 bg-white border-y border-gray-100">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-3 mb-10">
            {[
              { level: 1, badge: "Beginner", title: "Full-Body Integration", freq: "2× / week", color: "bg-blue-500", border: "border-blue-200 hover:border-blue-400" },
              { level: 2, badge: "Beginner+", title: "Full-Body Conditioning", freq: "3× / week", color: "bg-indigo-500", border: "border-indigo-200 hover:border-indigo-400" },
              { level: 3, badge: "Intermediate", title: "Upper / Lower Split", freq: "4× / week", color: "bg-primary", border: "border-primary/30 hover:border-primary" },
              { level: 4, badge: "Intermediate+", title: "Push · Pull · Legs", freq: "5× / week", color: "bg-amber-500", border: "border-amber-200 hover:border-amber-400" },
              { level: 5, badge: "Advanced", title: "5-Day Split + Cardio", freq: "5–6× / week", color: "bg-red-500", border: "border-red-200 hover:border-red-400" },
            ].map((l, i) => (
              <motion.a key={l.level} href="/guide" initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.07 }}
                className={`group block border-2 ${l.border} bg-[#f8fbf3] p-5 transition-all hover:shadow-md cursor-pointer`}>
                <div className={`w-9 h-9 ${l.color} flex items-center justify-center mb-3`}>
                  <span className="font-display font-black text-white text-base">{l.level}</span>
                </div>
                <div className="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-1">{l.badge}</div>
                <h4 className="font-display font-black uppercase tracking-tight text-gray-900 text-sm leading-tight mb-2">{l.title}</h4>
                <div className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">{l.freq}</div>
                <div className="mt-3 flex items-center gap-1 text-[10px] font-black text-primary uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity">
          ...
          <div className="text-center">
            <a href="/guide"
              className="inline-flex items-center gap-3 px-10 py-5 bg-gray-950 hover:bg-gray-900 text-white font-black uppercase tracking-widest text-sm transition-colors shadow-xl">
              Open Full Guide — 40+ Exercises <ArrowRight className="w-4 h-4" />
            </a>
            <p className="text-xs text-gray-400 font-medium mt-3 uppercase tracking-widest">Exercise encyclopedia · Form guides · Visual references</p>
          </div>
        </div>
      </section>
